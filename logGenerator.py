...
client_message = "TRACE|ClientName|Hello there!"
...
def assign_client_id(ip_to_check):
    ...
    return client_id_dictionary[ip_to_check][0]  # Always return the assigned ID
...
def generate_log_message(client_ip_address, client_port, received_client_message):
    ...
    if split_message[message_identifier] in VALID_LOGS:
        ...
        message_object = {}  # Create the blank message object to start
